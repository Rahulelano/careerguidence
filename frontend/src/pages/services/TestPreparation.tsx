...
import { ArrowRight, BookOpen, Target, Trophy, CheckCircle, ArrowLeft } from "lucide-react";
...
const TestPreparation = () => {
  ...
  const processSteps = [
    {
      icon: BookOpen,
      title: "Study Plan",
      description: "Customized study schedule based on your strengths and weaknesses"
    },
    {
      icon: Target,
      title: "Practice Sessions",
      description: "Regular mock tests and practice sessions with detailed analysis"
    },
    {
      icon: Trophy,
      title: "Performance Tracking",
      description: "Continuous monitoring and improvement strategies"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Comprehensive coaching for entrance exams with personalized study plans and expert guidance
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              Complete test preparation package with personalized coaching and practice
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-primary-foreground/90">
              Systematic approach to maximize your test scores and performance
            </p>
          </div>
      ...
      <section id="contact-form" className="py-16 bg-gradient-to-br from-purple-50 via-blue-50 to-pink-50">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
                Get Test Preparation Support
              </h2>
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Fill out the form below and our test prep experts will help you prepare effectively
              </p>
            </div>

            <div className="flex justify-center">
              <ServiceContactForm serviceName="Test Preparation" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 text-primary-foreground/90 max-w-2xl mx-auto">
            Get expert coaching and personalized preparation for your entrance exams
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
